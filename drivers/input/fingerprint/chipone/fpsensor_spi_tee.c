...
#define FP_NOTIFY_ON                            DRM_PANEL_BLANK_UNBLANK //FB_BLANK_UNBLANK
#define FP_NOTIFY_OFF                           DRM_PANEL_BLANK_POWERDOWN //FB_BLANK_POWERDOWN
#define FP_NOTIFY_EVENT_BLANK                   DRM_PANEL_EARLY_EVENT_BLANK //FB_EVENT_BLANK
...
static void fpsensor_irq_gpio_cfg(fpsensor_data_t *fpsensor)
{
    ...
    fpsensor_debug(INFO_LOG, "fpsensor irq number[%d]\n", fpsensor->irq);
    if (fpsensor->irq <= 0) {
...
static int fpsensor_get_gpio_dts_info(fpsensor_data_t *fpsensor)
{
    ...
    fpsensor_debug(INFO_LOG, "set power_gpio high\n");
